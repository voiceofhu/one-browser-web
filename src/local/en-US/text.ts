export const enUSTextMessages: Record<string, string> = {
  ...
  用户角色: "User roles",
  全局角色: "Global role",
  "Web 菜单与权限": "Web menus and permissions",
  "App 全局权限": "App global permissions",
  角色类型: "Role type",
  ...
  按管理域分类: "Grouped by domain",
  分组总览: "Grouped overview",
  分类合计: "Group total",
  账号与权限: "Accounts and permissions",
  字典与内容: "Dictionary and content",
  账号权限: "Accounts and access",
  基础配置: "Base configuration",
  权限体系: "Access model",
  配置内容: "Configuration and content",
  当前会话: "Current session",
  服务与依赖: "Service and dependencies",
